...
# Alex Powell Only
test_group_1 = """
SELECT CUST_NO, NAM, PHONE_1 as phone, LOY_PTS_BAL, CATEG_COD
FROM AR_CUST
...
retail_all = f"""
SELECT CUST_NO, NAM, PHONE_1, LOY_PTS_BAL, CATEG_COD
FROM AR_CUST
...
wholesale_all = f"""
SELECT CUST_NO, FST_NAM, PHONE_1, LOY_PTS_BAL, CATEG_COD
FROM AR_CUST
...
SELECT TOP 1000 CUST_NO, NAM, PHONE_1, LOY_PTS_BAL, CATEG_COD
FROM AR_CUST
WHERE CATEG_COD = 'RETAIL' AND 
{standard_filter}
...
SELECT TOP 2000 CUST_NO, NAM, PHONE_1, LOY_PTS_BAL, CATEG_COD
FROM AR_CUST
WHERE CATEG_COD = 'RETAIL' AND 
{standard_filter}
ORDER BY LST_SAL_DAT DESC
...
SELECT TOP 3000 CUST_NO, NAM, PHONE_1, LOY_PTS_BAL, CATEG_COD
FROM AR_CUST
WHERE CATEG_COD = 'RETAIL' AND 
{standard_filter}
ORDER BY LST_SAL_DAT DESC
...
SELECT TOP 4000 CUST_NO, NAM, PHONE_1, LOY_PTS_BAL, CATEG_COD
FROM AR_CUST
WHERE CATEG_COD = 'RETAIL' AND 
{standard_filter}
ORDER BY LST_SAL_DAT DESC
...
SELECT
"VI_PS_TKT_HIST"."CUST_NO", "AR_CUST"."NAM", "AR_CUST"."PHONE_1", "AR_CUST"."LOY_PTS_BAL", "AR_CUST"."CATEG_COD"
FROM
...
SELECT CUST_NO, BILL_NAM, BILL_PHONE_1, LOY_PTS_BAL, CATEG_COD
FROM VI_PS_TKT_HIST
